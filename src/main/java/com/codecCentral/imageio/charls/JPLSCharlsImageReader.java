...
public class JPLSCharlsImageReader extends ImageReader {

	private static Logger LOGGER = Logger.getLogger("com.codecCentral.imageio.charls");

	static {
		final String level = System.getProperty("com.codecCentral.imageio.charls.loggerlevel");
	...
	private final List<JPLSCodestreamProperties> multipleCodestreams = new ArrayList<JPLSCodestreamProperties>();

	private int numImages = 1;

	private CharlsDecoder decoder;

	protected JPLSCharlsImageReader(ImageReaderSpi originatingProvider) {
		super(originatingProvider);
		
		decoder = new CharlsDecoder();
	...
	public IIOMetadata getImageMetadata(int imageIndex) throws IOException {
		return new JPLSImageMetadata(multipleCodestreams.get(imageIndex));
	}
	...
	public Iterator<ImageTypeSpecifier> getImageTypes(int imageIndex)
		...
		final JPLSCodestreamProperties codestreamP = multipleCodestreams
				.get(imageIndex);
	...
	/**
	 * Build a default {@link JPLSCharlsImageReadParam}
	 */
	public ImageReadParam getDefaultReadParam() {
		return new JPLSCharlsImageReadParam();
	}
